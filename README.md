...
# 2026-02-18更新，拼读简并、冰雪一拼万象辅助
基于拼读简并按键和冰雪一拼的方案思路，然后再修改万象的方案，具有以下几个优点：

1、实现了万象方案的整句输入，兼容万象的所有特点，比如手动调频，ctrl jk 0p调整词频。

2、保留一击字、一击词（51个），左手右手单独击的时候，可以自动上屏前面的候选字，极大程度的减少了按空格的频率。

3、利用大写实现万象的辅助码辅助。

4、还能2、3、4、5、6候选一击出（按键是左手声介+y uo yp up ip op，51*6个），具体看方案内容。

5、 有两个模式，整句是整句版本，利用一击操作（左手单独击出一击字、右手单独击出符号、2-6候选一击出），可以实现顶功上屏，顶功是2字自动上屏版本，都支持大写字的辅助码。

![](vx_images/317355901864253.png)

![](vx_images/501285822886575.png)
...
> 总体思路就是用正常按键的C X Z S A+其他按键的组合键打出相应的声母，避开TGB
